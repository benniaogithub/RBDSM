...
def sentCombMat_verbOnly(w1,w2,w3):
    ...
    w2Mat = sio.loadmat(root+u"l_"+w1)[w1]
...
def GS2011_verbOnly():        #三个词组成的句子，向量相加 ,计算相似度按行
    ...
    for line in open(u"res/GS2011_RBDSM.txt"):
        ...
        sim1 = wordlantCosSimCol(sentCombMat_verbOnly(w11,w12,w13),sentCombMat_verbOnly(w21,w12,w13))
        sim2 = item[5]
        # print sim1
        wslist.append(sim1)
