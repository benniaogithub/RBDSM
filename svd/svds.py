...
def calculateSVDs(tolerance=0,refdim=300,dim = 400):
        ...
        source = u"I:/数据/word11247relation30/rel_30_ref_TFIDF/ref_"+str(refdim)+u"_TFIDF/rel_matrix/rel_mat/"
        dest = u"I:/数据/word11247relation30/rel_30_ref_TFIDF/ref_"+str(refdim)+u"_TFIDF/rel_svd/rel_matrix_ls/rel_mat_latent_"
        dests = u"I:/数据/word11247relation30/rel_30_ref_TFIDF/ref_"+str(refdim)+u"_TFIDF/rel_svd/rel_matrix_s/rel_mat_latent_"
        destus = u"I:/数据/word11247relation30/rel_30_ref_TFIDF/ref_"+str(refdim)+u"_TFIDF/rel_svd/rel_matrix_lus/rel_mat_latent_"
...
def SVDs(refdim=400):
    calculateSVDs(tolerance=0.001,refdim=refdim,dim = 200 )
    calculateSVDs(tolerance=0.001,refdim=refdim,dim = 100)
    ...
    rmTowm.rmTowmByGroup(refdim,dim = 100)
    rmTowm.rmTowmByGroup(refdim,dim = 200)
    rmTowm.rmTowmByGroupls(refdim,dim = 100)
    rmTowm.rmTowmByGroupls(refdim,dim = 200)
