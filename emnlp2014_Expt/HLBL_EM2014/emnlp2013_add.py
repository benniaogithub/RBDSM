...
def emnlp2013_add_Col():        #三个词组成的句子，向量相加 ,计算相似度按行

    wslist = []
    sdsmlist = []
    count = 1
    wordList = getWordList()
    for line in open(u"res/emnlp2013_turk_HLBL.txt"):
        item = line.strip("\n").split(" ")
        w11 = item[1]
        w12 = item[2]
        w13 = item[3]
        ...
        w22 = item[5]
        w23 = item[6]
        sim1 = vecSim(sentCombMat_add(w11,w12,w13),sentCombMat_add(w21,w22,w23))
        sim2 = item[7]
        # print sim1
        wslist.append(sim1)
