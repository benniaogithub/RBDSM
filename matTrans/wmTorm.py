...
def wmTorm(refdim=300):
        ...
        source = u"I:/数据/word11247relation30/rel_30_diffref_TFIDF/ref_"+str(refdim)+u"_TFIDF/file_word/file_word_mat/"
        dest = u"I:/数据/word11247relation30/rel_30_diffref_TFIDF/ref_"+str(refdim)+u"_TFIDF/rel_matrix/rel_mat/"
